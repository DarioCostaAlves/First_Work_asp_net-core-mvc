...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Dário Costa", "dario.c.alves@hotmail.com", new DateTime(2000, 7, 25), 4000.0,d1);
            Seller s2 = new Seller(2, "Ferdinand Mckay", "ferdinand.mckay@gmail.com", new DateTime(1999, 2, 28), 3000.0, d2);
            Seller s3 = new Seller(3, "Kevyn Martins", "kevyn_martins@hotmail.com", new DateTime(1990, 12, 05), 2000.0, d3);
            Seller s4 = new Seller(4, "Guilherme Luz", "gui_LED@gmail.com", new DateTime(1998, 11, 11), 1000.0, d2);
            Seller s5 = new Seller(5, "Pedro Vees", "pedro.vees@outlook.pt", new DateTime(1994, 1, 22), 2400.0, d3);
            Seller s6 = new Seller(6, "Bernardo Batista", "carServices@gmail.com", new DateTime(1992, 4, 14), 1900.0, d4);
